...
dev_server = {
    ...
    "start": function() {
        ...
        self.watchFiles();
setTimeout(function() {
        self.process = child_process.spawn(process.ARGV[0], ['server.js']);
        self.process.stdout.addListener('data', function (data) {
            process.stdout.write(data);
        });

        self.process.stderr.addListener('data', function (data) {
            sys.print(data);
        });

        self.process.addListener('exit', function (code) {
