...
(function() {
  var activityDefinitionTransformer, moment, orderFromActivityDefinition, processDefinitionToLaneOrder, _;
  ...
  */
  ...
  module.exports = function(processDefinition, processInstances) {
    var activity, activityDefinition, activityDefinitionForGroup, activityDefinitionUUID, activityDefinitions, adMap, afterTime, beforeTime, card, group, i, instance, instanceStateUpdates, lane, lastUpdate, myLane, result, startedDate, totalTime, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _m, _n, _o, _p, _ref, _ref1, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
    result = {
      lanes: []
    };
    /*
    ...
    */
    ...
    _ref1 = _.filter(_.sortBy(activityDefinitions, function(x) {
      return x.order;
    }), function(x) {
      return x.isState;
    });
    ...
    */
    ...
    for (i = _j = 1, _ref2 = result.lanes.length - 1; 1 <= _ref2 ? _j <= _ref2 : _j >= _ref2; i = 1 <= _ref2 ? ++_j : --_j) {
    ...
    */
    ...
    for (_k = 0, _len1 = _ref3.length; _k < _len1; _k++) {
      lane = _ref3[_k];
      _ref4 = lane.activityDefinitions;
      for (_l = 0, _len2 = _ref4.length; _l < _len2; _l++) {
        activityDefinition = _ref4[_l];
    ...
    */
    ...
    for (_m = 0, _len3 = processInstances.length; _m < _len3; _m++) {
      ...
      _ref6 = (_ref5 = instance.activities) != null ? _ref5.ActivityInstance : void 0;
      for (_n = 0, _len4 = _ref6.length; _n < _len4; _n++) {
        activity = _ref6[_n];
        activityDefinitionUUID = (_ref7 = activity.activityDefinitionUUID) != null ? _ref7.value : void 0;
        if (activity.state !== "FINISHED") {
          ...
          */
          ...
          if (myLane) {
            myLane.cards.push({
              id: (_ref8 = activity.uuid) != null ? _ref8.value : void 0,
              desc: activity.label,
              ready: ((_ref9 = activity.state) != null ? _ref9.toUpperCase() : void 0) === "READY",
      ...
      _ref10 = result.lanes;
      for (_o = 0, _len5 = _ref10.length; _o < _len5; _o++) {
        lane = _ref10[_o];
        _ref11 = lane.cards;
