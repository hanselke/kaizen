...
(function() {
  ...
  module.exports = QueryRuntime = (function() {
    ...
    function QueryRuntime(client) {
      this.client = client;
      this.getOneTaskByProcessInstanceUUIDAndActivityState = __bind(this.getOneTaskByProcessInstanceUUIDAndActivityState, this);

      this.getTaskCandidates = __bind(this.getTaskCandidates, this);
    ...
    */
    ...
    QueryRuntime.prototype.getTask = function(taskUUID, actAsUser, opts, cb) {
      if (opts == null) {
        opts = {};
      }
      if (cb == null) {
      ...
      return this.client.post("/API/queryRuntimeAPI/getTask/" + taskUUID, actAsUser, {}, opts, cb);
    };
    ...
    */
    ...
    QueryRuntime.prototype.getTaskCandidates = function(taskUUID, actAsUser, opts, cb) {
      if (opts == null) {
        opts = {};
      }
      if (cb == null) {
      ...
      return this.client.post("/API/queryRuntimeAPI/getTaskCandidates/" + taskUUID, actAsUser, {}, opts, cb);
    };
    ...
    */
    ...
    QueryRuntime.prototype.getOneTaskByProcessInstanceUUIDAndActivityState = function(processInstanceUUID, state, actAsUser, opts, cb) {
      if (state == null) {
        state = "READY";
      }
      if (opts == null) {
      ...
      return this.client.post("/API/queryRuntimeAPI/getOneTaskByProcessInstanceUUIDAndActivityState/" + processInstanceUUID + "/" + state, actAsUser, {}, opts, cb);
    };
