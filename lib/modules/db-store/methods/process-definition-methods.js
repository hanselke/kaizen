...
(function() {
  var MAXCOUNTOBJECTS, MAXFOLLOWERSPERBUCKET, ObjectId, PageResult, PageResultInfinite, ProcessDefinitionMethods, errors, intToAlpha26String, mongoose, _,
  ...
  */
  ...
  module.exports = ProcessDefinitionMethods = (function() {
    ...
    */
    ...
    ProcessDefinitionMethods.prototype.all = function(actor, offset, count, cb) {
      var _this = this;
      if (offset == null) {
        offset = 0;
      }
      ...
      return this.models.ProcessDefinition.count({}, function(err, totalCount) {
        ...
        return _this.models.ProcessDefinition.find({}, null, {
          skip: offset,
          limit: count
        }, function(err, items) {
          if (err) {
