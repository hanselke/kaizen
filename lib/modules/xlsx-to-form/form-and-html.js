...
(function() {
  ...
  FormAndHmtl = (function() {
    ...
    FormAndHmtl.prototype.createCss = function(form) {
      var cssClass, result, _i, _len, _ref;
      result = "";
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (cssClass.fontName && cssClass.fontName.length > 0) {
          result += "font-name:\"" + cssClass.fontName + "\";";
        }
        ...
        if (cssClass.textDecoration && cssClass.textDecoration.length > 0) {
          result += "text-decoration:" + cssClass.textDecoration + ";";
        }
    ...
    FormAndHmtl.prototype.createHtml = function(form) {
      var c, cell, height, r, row, totalWidth, width, writer, x, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2;
