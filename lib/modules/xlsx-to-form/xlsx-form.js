...
(function() {
  ...
  module.exports = XlsxForm = (function() {
    ...
    function XlsxForm() {
      this.mergeDataIntoForm = __bind(this.mergeDataIntoForm, this);
    ...
    XlsxForm.prototype.mergeDataIntoForm = function(base64Source, data, cb) {
      this.xlsx = xlsxParser(base64Source);
      return cb(null, this.xlsx.base64);
    };
