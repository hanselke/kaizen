...
(function() {
  ...
  module.exports = RoutesApi = (function() {
    ...
    function RoutesApi(settings) {
      this._stateMachineForProcessDefinition = __bind(this._stateMachineForProcessDefinition, this);
    ...
    RoutesApi.prototype.validateProcessDefinition = function(req, res, next) {
      ...
      return this.dbStore.processDefinitions.get(processDefinitionId, null, true, function(err, item) {
        ...
        return _this._stateMachineForProcessDefinition(item, function(err, sm) {
          var result;
          if (err) {
            return next(err);
          }
    ...
    */
    ...
    RoutesApi.prototype._stateMachineForProcessDefinition = function(processDefinition, cb) {
      var sm, smData;
