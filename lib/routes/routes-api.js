...
(function() {
  var RoutesApi, async, errors, fs, winston, xlsxToForm, _,
  ...
  module.exports = RoutesApi = (function() {
    ...
    function RoutesApi(settings, servicesBonita) {
      ...
      this.getTasksXXX = __bind(this.getTasksXXX, this);
    ...
    RoutesApi.prototype.setupRoutes = function() {
      ...
      return this.app.get('/api/process-definitions/:processDefinitionId/form-html', this.getProcessDefinitionHtml);
    };
    ...
    */
    ...
    RoutesApi.prototype.getTasks = function(req, res, next) {
      ...
      return this.dbStore.tasks.getActiveTask(req.user.id || req.user._id, {}, function(err, task) {
        ...
        */
        ...
        return _this.bonitaClient.queryRuntime.getOneTask("READY", req.user.username, null, function(err, taskList) {
          var firstTaskUUID;
          if (err) {
            return next(err);
          }
          ...
          if (firstTaskUUID) {
            ...
            return _this.bonitaClient.queryRuntime.getTask(firstTaskUUID, req.user.username, {}, function(err, t) {
              var processInstanceUUID, _ref;
              if (err) {
                return next(err);
              }
              processInstanceUUID = t != null ? (_ref = t.instanceUUID) != null ? _ref.value : void 0 : void 0;
              console.log("------3 .. Assign that task");
              return _this.bonitaClient.runtime.assignTask(firstTaskUUID, req.user.username, req.user.username, {}, function(err) {
                var data;
                if (err) {
                  return next(err);
                }
                ...
                return _this.dbStore.tasks.patchByProcessInstanceUUID(processInstanceUUID, data, {
                  actor: {
                  ...
                  result = _this.bonitaTransformer.toNextAction(firstTaskUUID, _this.servicesBonita.baseUrl);
                  item.id = item._id;
                  return res.json({
    ...
    RoutesApi.prototype.getTasksXXX = function(req, res, next) {
      var _this = this;
      if (!req.user) {
        return res.json({}, 401);
      }
    ...
    RoutesApi.prototype.completeTask = function(req, res, next) {
      ...
      return this.dbStore.tasks.get(req.params.taskId, {}, function(err, item) {
        ...
        return _this.bonitaClient.runtime.executeTask(item.activeTaskUUID, true, req.user.username, {}, function(err) {
          var data;
          if (err) {
            return next(err);
          }
    ...
    RoutesApi.prototype.getProcessDefinitionHtml = function(req, res, next) {
      ...
      return this.dbStore.processDefinitions.get(processDefinitionId, null, true, function(err, item) {
        ...
        */
        ...
        return xlsxToForm.createHtmlFromLayoutForm(item.layout, function(err, html) {
          if (err) {
            return done(err);
          }
          html = "" + html;
    ...
    RoutesApi.prototype.getExcel = function(req, res, next) {
      ...
      return this.dbStore.tasks.get(req.params.taskId, {}, function(err, task) {
        ...
        return _this.dbStore.processDefinitions.get(task.processDefinitionId, null, true, function(err, processDefinition) {
          ...
          return xlsxToForm.mergeDataIntoForm(processDefinition.sourceXlsx, task.data, function(err, data) {
