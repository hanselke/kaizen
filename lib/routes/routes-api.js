...
(function() {
  ...
  module.exports = RoutesApi = (function() {
    ...
    RoutesApi.prototype.setupRoutes = function() {
      ...
      return this.app["delete"]('/api/admin/process-definitions/:processDefinitionId', this.deleteAdminProcessDefinition);
    };
    ...
    */
    ...
    RoutesApi.prototype.getAdminProcessDefinitions = function(req, res, next) {
      ...
      return this.dbStore.processDefinitions.all(0, 100, function(err, result) {
        if (err) {
          return next(err);
        }
        return res.json(result);
    ...
    RoutesApi.prototype.postAdminProcessDefinitions = function(req, res, next) {
      var _this = this;
      return this.dbStore.processDefinitions.create(req.body, function(err, item) {
    ...
    RoutesApi.prototype.deleteAdminProcessDefinition = function(req, res, next) {
      ...
      return this.dbStore.processDefinitions.destroy(processDefinitionId, null, function(err, item) {
        if (err) {
          return next(err);
        }
        return res.json({});
