  ...
  module.exports = RoutesApi = (function() {
    ...
    */
    ...
    RoutesApi.prototype.createTask = function(req, res, next) {
      ...
      return this._stateMachineForProcessDefinitionId(req.body.processDefinitionId, function(err, sm) {
        var initialState, payload;
        if (err) {
          return next(err);
        }
    ...
    RoutesApi.prototype.getBoard = function(req, res, next) {
      ...
      return this._stateMachineForProcessDefinitionId(processDefinitionId, function(err, sm) {
        var board, i, state, _i, _len, _ref;
        if (err) {
          return next(err);
        }
        board = {
        ...
        return _this.dbStore.tasks.tasksForBoard(processDefinitionId, {}, function(err, pagedResult) {
