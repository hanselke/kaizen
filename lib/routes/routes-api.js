          ...
          */
          ...
          return _this.bonitaClient.runtime.executeTask(firstTaskUUID, true, req.user.username, opts = {}, function(err) {
            ...
            */
            ...
            return this.bonitaClient.runtime.getTask(firstTaskUUID, "admin", {}, function(err, t) {
              ...
              console.log("------3");
              processInstanceId = t != null ? (_ref = t.ActivityInstance) != null ? _ref.instanceUUID : void 0 : void 0;
              ...
              */
              ...
              return _this.bonitaClient.runtime.getOneTaskByProcessInstanceUUIDAndActivityState(processInstanceId, "READY", req.user.username, {}, function(err, nextTask) {
                var taskUUID;
                console.log("------4");
                console.log(JSON.stringify(nextTask));
                console.log("------4");
                taskUUID = nextTask != null ? nextTask.value : void 0;
                return _this.bonitaClient.runtime.startTask(taskUUID, req.user.username, "admin", {}, function(err) {
                  var result;
                  console.log("------5");
                  console.log("EXECUTE");
                  console.log("------5");
