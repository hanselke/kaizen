...
(function() {
  ...
  module.exports = RoutesUsers = (function() {
    ...
    function RoutesUsers(settings) {
      this.signOutGet = __bind(this.signOutGet, this);
    ...
    RoutesUsers.prototype.setupRoutes = function() {
      ...
      this.app.post('/users/sign-in', validateSignIn, this.passport.authenticate("local", {
        failureRedirect: "/users/sign-in?error=1"
      }), this.signInPost);
      return this.app.get('/users/sign-out', this.signOutGet);
    };
    ...
    */
    ...
    RoutesUsers.prototype.signOutGet = function(req, res) {
      req.logOut();
      return this._nextRedirect(req, res);
    };
