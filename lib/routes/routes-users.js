...
(function() {
  ...
  module.exports = RoutesUsers = (function() {
    ...
    RoutesUsers.prototype.setupLocals = function() {
      this.app.locals.routesUsers = this.routesUsersPathHelper = new RoutesUsersPathHelper;
      return this.app.get('/current_user', this.getCurrentUser);
    };
    ...
    RoutesUsers.prototype.getCurrentUser = function(req, res) {
      if (!req.user) {
        return res.json({}, 404);
      }
