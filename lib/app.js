...
(function() {
  var App, PassportBearerStrategy, PassportLocalStrategy, RoutesAdminUsers, RoutesApi, RoutesApiAdminBoards, RoutesApiAdminProcessDefinitions, RoutesApiBoard, RoutesApiProcessDefinitions, RoutesApiTasks, RoutesApp, RoutesProxy, RoutesRoot, RoutesSetup, RoutesUsers, airbrake, bonitaClientPackage, bonitaTransformer, businessLogicPackage, checkNeedsInit, checkPerformSiteAction, checkUserNeedsSetup, color, config, cookieDumper, corser, corserMiddleware, dbStorePackage, env, errorHandling, errors, express, expressFormsFix, expressMessages, flash, fullyQualifiedUrl, identityStorePackage, legacyUser, logHandling, mongoose, passport, passportSetup, path, protectResource, routeActive, socketIOHandling, stylus, trace, voila, winston, _,
  ...
  module.exports = App = (function() {
    ...
    */
    ...
    App.prototype.start = function(port, cb) {
      var baseUrl, dummyFn, key, route, settings, _ref, _ref1, _ref2, _ref3,
        _this = this;
      if (port == null) {
        port = null;
      }
      ...
      */
      ...
      this.app = express();
      this.database = mongoose.connect(config.get('services:db'));
      this.identityStore = identityStorePackage.store({
        oauthProvider: config.get('provider')
      });
      this.bonitaClient = bonitaClientPackage.client(config.get('services:bonita'));
      this.dbStore = dbStorePackage.store();
      this.businessLogic = businessLogicPackage.businessLogic({
      ...
      this.app.use('/app', protectResource());
      this.app.use(legacyUser());
      ...
      settings = {
        ...
        bonitaClient: this.bonitaClient,
      ...
      dummyFn = function(userId, cb) {
        return cb();
      };
      this.app.use(checkUserNeedsSetup(dummyFn, (_ref = this.identityStore) != null ? (_ref1 = _ref.users) != null ? _ref1.removeRoles : void 0 : void 0));
