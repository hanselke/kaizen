...
(function() {
  var App, PassportBearerStrategy, PassportLocalStrategy, RoutesAdminUsers, RoutesApi, RoutesLegacy, RoutesRoot, RoutesUsers, airbrake, backend, bonitaClientPackage, bonitaTransformer, checkNeedsInit, checkPerformSiteAction, checkUserNeedsSetup, color, config, cookieDumper, corser, corserMiddleware, env, errorHandling, errors, express, expressFormsFix, expressMessages, flash, fullyQualifiedUrl, identityStorePackage, legacyUser, logHandling, mongoose, passport, passportSetup, path, routeActive, socketIOHandling, stylus, trace, voila, winston, _,
  ...
  module.exports = App = (function() {
    ...
    */
    ...
    App.prototype.start = function(port, cb) {
      var baseUrl, childProcess, database_dir, dummyFn, fs, key, route, settings, _ref, _ref1, _ref2, _ref3,
        _this = this;
      if (port == null) {
        port = null;
      }
