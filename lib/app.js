...
(function() {
  var App, PassportBearerStrategy, PassportLocalStrategy, RoutesAdminUsers, RoutesApi, RoutesApiAdminBoards, RoutesApiAdminProcessDefinitions, RoutesApiBoard, RoutesApiProcessDefinitions, RoutesApiTasks, RoutesApp, RoutesProxy, RoutesRoot, RoutesSetup, RoutesUsers, airbrake, bonitaClientPackage, bonitaTransformer, checkNeedsInit, checkPerformSiteAction, checkUserNeedsSetup, color, config, cookieDumper, corser, corserMiddleware, dbStorePackage, env, errorHandling, errors, express, expressFormsFix, expressMessages, flash, fullyQualifiedUrl, identityStorePackage, legacyUser, logHandling, mongoose, passport, passportSetup, path, protectResource, routeActive, socketIOHandling, stylus, trace, voila, winston, _,
