...
(function() {
  var App, PassportBearerStrategy, PassportLocalStrategy, airbrake, checkNeedsInit, checkPerformSiteAction, checkUserNeedsSetup, color, config, cookieDumper, env, errorHandling, errors, express, expressFormsFix, expressMessages, flash, fullyQualifiedUrl, passport, passportSetup, path, routeActive, stylus, trace, voila, winston, _,
