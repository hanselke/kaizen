...
(function() {
  var App, PassportBearerStrategy, PassportLocalStrategy, RoutesAdminUsers, RoutesApi, RoutesApp, RoutesProxy, RoutesRoot, RoutesUsers, airbrake, bonitaClientPackage, bonitaTransformer, checkNeedsInit, checkPerformSiteAction, checkUserNeedsSetup, color, config, cookieDumper, corser, corserMiddleware, env, errorHandling, errors, express, expressFormsFix, expressMessages, flash, fullyQualifiedUrl, identityStorePackage, legacyUser, logHandling, mongoose, passport, passportSetup, path, protectResource, routeActive, socketIOHandling, stylus, trace, voila, winston, _,
