...
(function() {
  var App, PassportBearerStrategy, PassportLocalStrategy, RoutesAdminUsers, RoutesLegacy, RoutesRoot, airbrake, backend, checkNeedsInit, checkPerformSiteAction, checkUserNeedsSetup, color, config, cookieDumper, corser, corserMiddleware, env, errorHandling, errors, express, expressFormsFix, expressMessages, flash, fullyQualifiedUrl, identityStorePackage, logHandling, mongoose, passport, passportSetup, path, routeActive, socketIOHandling, stylus, trace, voila, winston, _,
