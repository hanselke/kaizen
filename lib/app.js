...
(function() {
  var App, PassportBearerStrategy, PassportLocalStrategy, RoutesAdminUsers, RoutesApi, RoutesLegacy, RoutesRoot, RoutesUsers, airbrake, backend, bonitaClientPackage, checkNeedsInit, checkPerformSiteAction, checkUserNeedsSetup, color, config, cookieDumper, corser, corserMiddleware, env, errorHandling, errors, express, expressFormsFix, expressMessages, flash, fullyQualifiedUrl, identityStorePackage, legacyUser, logHandling, mongoose, passport, passportSetup, path, routeActive, socketIOHandling, stylus, trace, voila, winston, _,
