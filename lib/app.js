...
(function() {
  var App, PassportBearerStrategy, PassportLocalStrategy, RoutesRoot, airbrake, checkNeedsInit, checkPerformSiteAction, checkUserNeedsSetup, color, config, cookieDumper, corser, corserMiddleware, env, errorHandling, errors, express, expressFormsFix, expressMessages, flash, fullyQualifiedUrl, identityStorePackage, mongoose, passport, passportSetup, path, routeActive, stylus, trace, voila, winston, _,
  ...
  module.exports = App = (function() {
    ...
    */
    ...
    App.prototype.start = function(port, cb) {
      var baseUrl, key, route, settings, _ref, _ref1, _ref2, _ref3, _ref4, _ref5,
        _this = this;
      if (port == null) {
        port = null;
      }
      ...
      */
      ...
      this.app.use(checkUserNeedsSetup((_ref = this.appApiClient) != null ? (_ref1 = _ref.actions) != null ? _ref1.setupNewUser : void 0 : void 0, (_ref2 = this.identityServiceClient) != null ? (_ref3 = _ref2.users) != null ? _ref3.deleteRoles : void 0 : void 0));
      ...
      passportSetup(this.app, this.identityServiceClient, config, baseUrl);
      _ref5 = this.routes;
      for (key in _ref5) {
        route = _ref5[key];
        route.setupRoutes();
