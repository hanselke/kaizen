  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_decimal() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, start, end) { return parseFloat (start.join("") + "." + end.join("")); })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_cell() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, col, row) {return window.resolveCell(row.join(""),col.join(""))})(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
